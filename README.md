...
Although these suggestions can not be applied to any programming language, I will use JavaScript to illustrate them in practice.

## English language

You must use English language when naming your variables and functions.
